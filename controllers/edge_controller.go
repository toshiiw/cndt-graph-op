...
//+kubebuilder:rbac:groups=graph.example.valinux.co.jp,resources=edges,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=graph.example.valinux.co.jp,resources=edges/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=graph.example.valinux.co.jp,resources=edges/finalizers,verbs=update
