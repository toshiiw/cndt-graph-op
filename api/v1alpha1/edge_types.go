...
type EdgeStatus struct {
	InMaxCut bool `json:"inmaxcut"`
}

//+kubebuilder:object:root=true
//+kubebuilder:subresource:status
//+kubebuilder:printcolumn:JSONPath=".spec.vertex[0]",name=Vertex1,type=string
//+kubebuilder:printcolumn:JSONPath=".spec.vertex[1]",name=Vertex2,type=string
